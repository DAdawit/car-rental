...
const RentalFleets = () => {
  return (
    <div>
      <div className="flex flex-col justify-center mx-10 pt-5 py-10">
        <h1 className="text-center text-primary font-serif text-3xl font-extrabold text-gray-900 tracking-widest mt-10">
          OUR RENTAL FLEETS
        </h1>
        <h5 className="text-center text-primary font-serif text-sm  text-gray-700 tracking-widest mt-1">
          Luxury AutoStar Rental Services
        </h5>
        <p className="max-w-xl text-center self-center mt-7 text-gray-600">
